...
import com.jjshouse.jgao.leqeealarm.R;
...
public class BackgroundMusic {
    ...
    public static final String bgMusic = "alarm_attraction.mp3";
    ...
    public static boolean isStopPlay() {
        return stopPlay;
    }

    public static void setStopPlay(boolean stopPlay) {
        BackgroundMusic.stopPlay = stopPlay;
    }
            ...
            try {
                mBackgroundMediaPlayer.setOnCompletionListener(new OnCompletionListener() {
                        ...
                        public void onCompletion(MediaPlayer mp) {
                            mLeftVolume =  mLeftVolume + 0.2f;
                            mRightVolume = mRightVolume + 0.2f;
    ...
    private MediaPlayer createMediaplayerFromAssets(String path) {
        ...
        try {
            //Log.i(TAG, mContext.getAssets().hashCode());
